  ...
  <div class="container">
    <div class="row gy-5 gx-4 g-xl-5">
      ...
      <div class="col-lg-6">
        <article class="card post-card h-100 border-0 bg-transparent">
          <div class="card-body">
            <a class="d-block" href="blog-single.php" title="3 reasons why sodium-ion batteries may dethrone lithium">
              <div class="post-image position-relative">
      ...
      <div class="col-12">
        ...
        <nav class="text-center mt-5">
          <ul class="pagination justify-content-center border border-white rounded d-inline-flex">
            <li class="page-item"><a class="page-link rounded w-auto px-4" href="blog.php" aria-label="Pagination Arrow">Prev</a></li>
            ...
            <li class="page-item"><a class="page-link rounded" href="blog.php" aria-label="Pagination Arrow">16</a></li>
            <li class="page-item"><a class="page-link rounded w-auto px-4" href="blog.php" aria-label="Pagination Arrow">Next</a></li>
          </ul>
        </nav>
