      ...
      <div class="row justify-content-center">
        ...
        <div class="col-lg-8 post-content-block order-0 order-lg-2">
          ...
          <ul class="post-meta-tag list-unstyled list-inline mt-5">
            ...
            <li class="list-inline-item"><a class="bg-white" href="tag-single.php">Life</a></li>
            <li class="list-inline-item"><a class="bg-white" href="tag-single.php">Lighting</a></li>
          </ul>
        </div>
      </div>
          ...
          <div class="col-lg-10">
            <div class="d-block d-md-flex">
              ...
              <div class="ms-0 ms-md-4 ps-0 ps-md-3 mt-4 mt-md-0">
                <h3 class="h4 mb-3"><a href="author-single.php" class="text-dark">Thomas Macaulay</a></h3>
                ...
                <div class="content"><a href="author-single.php">See all posts by this author <i class="ti ti-arrow-up-right"></i></a></div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="block">
              ...
              <script type="application/javascript">
                ...
                (function() {
                  ...
                  s.async = true;
                  s.src = '//' + "platol" + '.disqus.com/embed.js';
            ...
            <div class="row gy-5 gx-4 g-xl-5">
              ...
              <div class="col-lg-6">
                <article class="card post-card h-100 border-0 bg-transparent">
                  <div class="card-body">
                    <a class="d-block" href="blog-single.php" title="Everything you wanted to know about the metaverse">
                  ...
                  <div class="card-footer border-top-0 bg-transparent p-0">
                    <ul class="card-meta list-inline">
                      <li class="list-inline-item mt-2">
                        <a href="author-single.php" class="card-meta-author" title="Read all posts by - Emma Hazel">
                      ...
                      <li class="list-inline-item mt-2">
                        <ul class="card-meta-tag list-inline">
                          <li class="list-inline-item small"><a href="tag-single.php">Life</a></li>
                        </ul>
                      </li>
                    </ul>
                  </div>
              ...
              <div class="col-lg-6">
                <article class="card post-card h-100 border-0 bg-transparent">
                  <div class="card-body">
                    <a class="d-block" href="blog-single.php" title="The AGI hype train is running out of steam">
                      <div class="post-image position-relative">
