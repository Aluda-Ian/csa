        ...
        <div class="col-lg-10 mx-auto">
          <div class="row gx-4 gy-5 gx-md-5 justify-content-center text-center">
            ...
            <div class="col-md-4 col-sm-6">
              <a class="d-inline-block is-hoverable" href="author-single.php">
  ...
  <section class="section-sm pb-0">
    <div class="container">
      ...
      <div class="row gy-5 gx-4 g-xl-5">
              ...
              <ul class="card-meta list-inline">
                ...
                <li class="list-inline-item mt-2">
                  <ul class="card-meta-tag list-inline">
                    ...
                    <li class="list-inline-item small"><a href="tag-single.php">Lighting</a></li>
                  </ul>
                </li>
              </ul>
            </div>
        ...
        <div class="col-12 text-center">
          <a class="btn btn-primary mt-5" href="blog.php" aria-label="View all posts"><i class="ti ti-new-section me-2"></i>View all posts</a>
        </div>
      </div>
    </div>
  </section>
